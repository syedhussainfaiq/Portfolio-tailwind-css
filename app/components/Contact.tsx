        ...
        <div className='grid-md:grid-cols-2 gap-10'>
            <div className='space-y-8'>
                ...
                <p className='text-gray-600 text-[18px] pt-2' data-aos="zoom-in-down"  >
                    Drop me a line, give me a call, or send me message by the submitting the form.
                </p>
                < div className='flex gap-3 items-center'data-aos="zoom-in-down">
                <MdMarkEmailRead  size={30} /> syedfaiqhussain78@gmail.com
                </div>
                <div className='flex gap-3 items-center'data-aos="zoom-in-down" >
                < BsFillTelephoneInboundFill size={30}/> 03039495445
                </div>
            </div>
            <div className='space-y-8'>
